...
const { isLoading, getFiles, addDeleteFileId, addUpdateFileId, addEmptyFile, saveAllfiles, filesPage, pageCount, pageId, pageSearch, deleteFileIds, updateFileIds, fileNeedSaveCount, updatePageCurrent } = await useFetchData<ApiData>(
  '/api/text-external'
)
