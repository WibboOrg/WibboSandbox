...
const { isLoading, getFiles, addDeleteFileId, addEmptyFile, saveAllfiles, filesPage, pageCount, pageId, pageSearch, addUpdateFileId, updateFileIds, fileNeedSaveCount, updatePageCurrent, deleteFileIds } = await useFetchData<ApiData>('/api/text-badge')
