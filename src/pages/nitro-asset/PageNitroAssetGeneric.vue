<template>
    <div class="grid grid-cols-1 gap-4">
        ...
        <div class="col-span-1">
            <BaseCard>
                <template #title>Nitro asset (Generic)</template>
                <template #body>
...
const { isLoading, getFiles, filesPage, pageCount, pageId, pageSearch, updatePageCurrent } = useFetchData<ApiData>('AssetNitro&category=generic', true)
