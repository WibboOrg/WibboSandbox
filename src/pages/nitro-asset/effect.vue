<template>
  <div class="grid grid-cols-1 gap-4">
    ...
    <div class="col-span-1">
      <BaseCard>
        <template #title>Nitro asset (Effect)</template>
        <template #body>
...
const { isLoading, getFiles, filesPage, pageCount, pageId, pageSearch, updatePageCurrent, saveAllfiles, fileNeedSaveCount, updateFileIds, uploadFiles } = await useFetchData<ApiData>('/api/asset/effect', true)
