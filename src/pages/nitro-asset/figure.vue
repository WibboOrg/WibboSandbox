...
const { isLoading, getFiles, filesPage, pageCount, pageId, pageSearch, updatePageCurrent, saveAllfiles, fileNeedSaveCount, updateFileIds } = await useFetchData<ApiData>('/api/asset/figure', true)
