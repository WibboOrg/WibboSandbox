...
const { isLoading, getFiles, filesPage, pageCount, pageId, pageSearch, updatePageCurrent, saveAllfiles, fileNeedSaveCount, updateFileIds, uploadFiles } = await useFetchData<ApiData>('/api/asset/figure', true)
