...
const { isLoading, getFiles, filesPage, pageCount, pageId, pageSearch, updateFileIds, updatePageCurrent, saveAllfiles, fileNeedSaveCount } = await useFetchData<ApiData>('/api/asset/pet', true)
