  ...
  <div class="grid grid-cols-1 gap-4">
    ...
    <div class="col-span-1 sticky top-0 z-10 backdrop-blur">
      ...
      <div class="flex flex-row gap-2 mt-2">
        ...
        <BaseButton @click="addEmptyFile({ id: -1, input: 'Input', minrank: 1, descriptionFr: 'Description' })">+ Ajouté</BaseButton>
          ...
          <BaseTable>
            ...
            <template #body>
              <BaseTableBody v-for="file in filesPage" :key="file.keyIndex" :is-updated="updateFileIds.includes(file.keyIndex || 0) || file.id <= -1" :is-deleted="deleteFileIds.includes(file.keyIndex || 0)">
                ...
                <BaseTableColunm>
                  <BaseInput v-model="file.input" text-to-edit @value-updated="addUpdateFileId(file)"></BaseInput>
                </BaseTableColunm>
                <BaseTableColunm>
                  <BaseInput v-model="file.minrank" text-to-edit number @value-updated="addUpdateFileId(file)"></BaseInput>
                </BaseTableColunm>
                <BaseTableColunm>
                  <BaseInput v-model="file.descriptionFr" text-to-edit @value-updated="addUpdateFileId(file)"></BaseInput>
                </BaseTableColunm>
                <BaseTableColunm>
