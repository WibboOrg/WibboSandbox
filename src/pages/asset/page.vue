<template>
  <div class="grid grid-cols-1 gap-4">
    ...
    <div class="col-span-1">
      <label class="text-xl font-bold">Importer des fichiers (pas d'extension)</label>
      <BaseUploadFile @upload="handleFileUpload" ref="baseUploadFileRef" multiple />
    ...
    <div class="col-span-1">
      <BaseCard>
        <template #title>Asset (Page html)</template>
        <template #body>
