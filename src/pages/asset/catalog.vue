<template>
  <div class="grid grid-cols-1 gap-4">
    ...
    <div class="col-span-1">
      <BaseCard>
        <template #title>Asset (Catalogue)</template>
        <template #body>
...
const { isLoading, getFiles, addDeleteFileId, uploadFiles, saveAllfiles, filesPage, pageCount, pageId, pageSearch, deleteFileIds, addUpdateFileId, updateFileIds, fileNeedSaveCount, updatePageCurrent } = await useFetchData<ApiData>(
  '/api/asset/catalogue',
  true
)
