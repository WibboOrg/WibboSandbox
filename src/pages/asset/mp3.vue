<template>
    <div class="grid grid-cols-1 gap-4">
        ...
        <div class="col-span-1">
            <BaseCard>
                <template #title>Asset (Mp3)</template>
                <template #body>
...
const { isLoading, deleteFile, getFiles, createFile, filesPage, pageCount, pageId, pageSearch, updatePageCurrent } = await useFetchData<ApiData>('/api/asset/mp3', true)
