<template>
    <div class="grid grid-cols-1 gap-4">
        ...
        <div class="col-span-1">
            <BaseCard>
                <template #title>Asset (Background)</template>
                <template #body>
...
const { isLoading, deleteFile, getFiles, createFile, filesPage, pageCount, pageId, pageSearch, updatePageCurrent } = await useFetchData<ApiData>('/api/asset/backgrounds', true)
